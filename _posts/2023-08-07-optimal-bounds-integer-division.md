...
$$
</div> respectively. Applying $\eqref{eq:floor splits; lower bound}$, it turns out that the first one minus the second one is equal to
<div>
$$
  (n_{0}+n_{1})\left(
    \frac{\left\lfloor n_{1}x\right\rfloor}{n_{1}}
